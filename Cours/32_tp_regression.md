...
A vous de me dire quel genre de probleme c'est, et quelles solutions vous y apportez...

Pour cela, vous disposez d'un fichier Colab de départ, qui lit la base de
données. A vous de compléter ce code pour tester les différentes méthodes et le réglage des paramètres.
