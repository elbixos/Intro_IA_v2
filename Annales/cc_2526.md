...
1. (1 pt) Pour quels problèmes peut on utiliser des SVM ?
2. (3 pts) Expliquez leur principe de fonctionnement. Détaillez le principe sans vous attarder sur les mathématiques. 
3. (1 pt) Dans quels cas peuvent ils s'avérer intéressants en comparaison des réseaux de neurones ?
...
1. (1 pts) Proposer, en la justifiant un ratio pour la séparation en base de test, base de généralisation.
...
3. (2.5 pts) Proposer une fonction de perte pour ce problème en le justifiant.
